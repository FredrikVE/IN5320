...
* Viktige komponentbegreper/syntaksbegreper for useEffect()

#+begin_src js
[] = dependency array
// Bestemmer når useEffect kjører (tom = bare ved mount)

() = callback function
// Funksjonen du gir som argument til useEffect

{} = function body
// Koden inni callback-funksjonen som kjøres når effekten trigges
#+end_src
...
2.
#+begin_src js
useEffect(() => {}, [])     //merk at listen med avhengigheter er eksplistt tom
...
* Cleanup function i useEffect()-hook
