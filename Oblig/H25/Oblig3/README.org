...
*** Opprette nytt app-prosjekt
Lag en tom mappe for applikasjonen din, åpne den i ønsket editor og kjør:

#+begin_src bash
d2 app scripts init <-- navn på mitt prosjekt -->
#+end_src

Da opprettes en ny mappe med alt nødvendig for ditt DHIS2-prosjekt (Med unntak av node.js og yarn).
